...
class Smelter(iMachine):
    ...
    footprint = 54
    inputs = {
        LogisticalInput.CONVEYOR: 1
    }
    outputs = {
        LogisticalInput.CONVEYOR: 1
    }
    cost = {
        ManufacturedComponents.IRON_ROD: 5,
        ManufacturedComponents.WIRE: 8
    }
